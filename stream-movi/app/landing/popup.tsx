...
export default function Popup() {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen gap-4 md:gap-6 p-4">
      <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center">🎬 Movie Streaming App</h1>
      <p className="text-gray-600 text-center text-sm md:text-base">Watch movies together in real-time</p>
      ...
      <div className="text-sm text-gray-500 mt-2 md:mt-4 text-center px-4">
